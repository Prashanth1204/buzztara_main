...
function Navbar() {
  return (
    <>
    <Nav style={{boxShadow: '0 10px 10px -10px #000000',margin: '0 0 40px 0'}}>
        <NavMenu>
        <NavLink to='/buzztara_main/safe' activeStyle style={{color:"#1F75FE"}}>
            MANAGE
          </NavLink>
          <NavLink to='/buzztara_main'  className="navbarunder" style={{marginLeft:"370px"}}>
            Overview
          </NavLink>
          <NavLink to='/buzztara_main/safe' >
            Safe
          </NavLink>
